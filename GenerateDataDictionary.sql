-- credit source: https://raw.githubusercontent.com/DataResearchLabs/sql_scripts/main/mssql/data_dictionary/data_dict_dump.sql
-- IMPORTANT
USE quasar_prod_warehouse.public;  -- <<<<<<<<<<<< CHANGE THIS VALUE to Schema you want to dump
;
