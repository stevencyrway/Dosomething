...
Select signups.northstar_id                                                  as signup_northstar_id,
       ...
       posts.id                                                              as post_id,
       case when parsedtags.tags = 'Bulk' then true else false end                  as Bulk,
       case when parsedtags.tags = 'Good For Brand' then true else false end        as GoodForBrand,
       case when parsedtags.tags = 'Good For Sponsor' then true else false end      as GoodforSponsor,
       case when parsedtags.tags = 'Good For Storytelling' then true else false end as GoodforStorytelling,
       case when parsedtags.tags = 'Good Quote' then true else false end            as GoodQuote,
       case when parsedtags.tags = 'Good Submission' then true else false end       as GoodSubmission,
       case when parsedtags.tags = 'Group Photo' then true else false end           as GroupPhoto,
       case when parsedtags.tags = 'Hide In Gallery' then true else false end       as HideInGallery,
       case when parsedtags.tags = 'Inappropriate' then true else false end         as Inappropriate,
       case when parsedtags.tags = 'Incomplete Action' then true else false end     as IncompleteAction,
       case when parsedtags.tags = 'Irrelevant' then true else false end            as Irrelevant,
       case when parsedtags.tags = 'Social' then true else false end                as Social,
       case when parsedtags.tags = 'Test' then true else false end                  as Test,
       case when parsedtags.tags = 'Unrealistic Hours' then true else false end     as UnrealisticHours,
       case when parsedtags.tags = 'Unrealistic Quantity' then true else false end  as UnrealisticQuantity,
       posts.is_reportback,
